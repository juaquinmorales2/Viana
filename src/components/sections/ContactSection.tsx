            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-lg font-medium hover:from-purple-700 hover:to-purple-900 transition-all"
              >
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">beatsviana@gmail.com</p>
                </div>
              </div>
            </div>
      ...
      {showModal && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 px-4">
            <div className="bg-purple-500/90 rounded-xl p-8 max-w-md w-full mx-4 animate-fade-in">
