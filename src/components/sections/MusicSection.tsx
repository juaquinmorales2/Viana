...
import mimundo from './mimundo.png'
import rame from './rame.png'
import populares from './populares.png'
...
const columns = [
  {
    ...
    tracks: [
      {
        id: "BCVGD3ZZT5o",
        url: "https://www.youtube.com/watch?v=BCVGD3ZZT5o",
        title: "Me Di Cuenta"
      },
      {
        id: "c6dTB9aPEcU",
        url: "https://youtu.be/c6dTB9aPEcU?si=nffXrlbS0bTrGjDJ",
        title: "Puede Ser"
      },
      {
        id: "AUDJ_vWPbiA",
      ...
      {
        id: "h105Yx4ca_4",
        url: "https://youtu.be/h105Yx4ca_4?si=W2MVWAlDGyc9_RIv",
        title: "Desierto"
      },
    ],
  },
  {
    ...
    tracks: [
      {
        id: "_t8DXMx7mpI",
        url: "https://youtu.be/_t8DXMx7mpI?si=xpw7HqiLkAP5Au5g",
        title: "Pueblo Infernal"
      },
      {
        id: "xGFPlR8r8yc",
        url: "https://youtu.be/xGFPlR8r8yc?si=s2KLFv5zI6VACfyI",
        title: "Noches"
      },
      {
        id: "WaAf8iReIkI",
        url: "https://youtu.be/WaAf8iReIkI?si=LnfmuEaadiE_DCHK",
        title: "Frío"
      },
      {
        id: "b2xeQa9HPkg",
        url: "https://youtu.be/b2xeQa9HPkg?si=lwHn217GtXnzjohy",
        title: "Detrás de una pared"
      },
    ],
  },
  {
    title: "Album: Mi Mundo",
    background:
      mimundo,
    tracks: [
      {
        id: "tILHGoyg-fs",
        url: "https://youtu.be/tILHGoyg-fs?si=uc2OnnfGE0lVjRur",
        title: "Con Vos"
      },
      {
        id: "N6ZYkHK4uWE",
        url: "https://youtu.be/N6ZYkHK4uWE?si=UOpJcw_O77x9IfhF",
        title: "Se va volando"
      },
      {
        id: "msj8wg4LwNA",
        url: "https://youtu.be/msj8wg4LwNA?si=aBi0rSjXQKCN-dQ0",
        title: "Lejos"
      },
      {
        id: "A8VZrUYMDSo",
        url: "https://youtu.be/A8VZrUYMDSo?si=BLoHf4fvWXX3SE4e",
        title: "Así sabrás"
      },
    ],
  },
    ...
    >
      <div className="container mx-auto px-4 mt-20 mb-10">
        <div className="text-center mb-16">
          ...
          >
            Explora mis últimos lanzamientos y descubre el universo sonoro que he creado a lo largo de mi carrera.
          </p>
        </div>
                ...
                <div className="relative p-6 text-white">
                      ...
                      <div key={track.id} className="mb-6">
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            ...
                            className={`bg-purple-600 p-2 rounded-full hover:bg-purple-700 transition-colors flex items-center text-center justify-center`}
                  ...
                  <div className="mt-6">
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-300 transition-colors text-white font-semibold px-4 py-2 rounded-full"
                    >
                      <SpotifyIcon />
